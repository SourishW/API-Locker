...
const LicensingInfo = (props) => {
  ...
  const handleChange = ({ target }) => {
    ...
    props.setLicensingInfo((prev) => ({
      ...prev,
      [props.licenseNumber]: updateAttribute(
        prev[props.licenseNumber],
        name,
        value
      ),
    }));
      ...
      <form onSubmit={handleSubmit} className="licensingInfo__form">
        ...
        <div className="licensingInfo__form__item">
          ...
          <textarea
            ...
            type="text"
            placeholder="Describe the purpose of the license for the service."
            onChange={handleChange}
          />
        </div>
        ...
        <div className="licensingInfo__form__item">
          <label
            ...
            className="licensingInfo__form__item__label"
          >
            (Optional) Action/Expiry Date (we'll remind you to renew with a
            notification):
          </label>
          <input
            id="expiryDate"
